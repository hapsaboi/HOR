...
<body>
  ...
  <header id="header" class="header-tops">
    <div class="container">
      ...
      <h1><a href="index.html">HOUSE OF REFUGE</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->
      <h2>A place of <span>Safety</span>...God is with us.</h2>
      ...
      <div class="row">
        ...
        <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
          ...
          <div class="row">
            <div class="col-lg-6">
              <ul>
                <li><i class="icofont-rounded-right"></i> <strong>Birthday:</strong> 1 May 2001</li>
      ...
      <div class="row mt-2">
        ...
        <div class="col-md-6 d-flex align-items-stretch">
          <div class="info-box">
            <i class="bx bx-map"></i>
            <h3>Address</h3>
            <p>Behind Unity Bank, Bekaji Housin Estate, Yola, Nigeria.</p>
          </div>
        </div>
